		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First UI5 App",
									"targetURL": "#appfirstsapui5project1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appfirstsapui5project1-display": {
								"semanticObject": "appfirstsapui5project1",
								"action": "display",
								"description": "Base appliation",
								"title": "First UI5 App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.first.sapui5project1",
									"url": sap.ui.require.toUrl("app/first/sapui5project1")
								}
							}
						}
					}
